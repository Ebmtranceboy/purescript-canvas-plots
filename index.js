...
(function($PS) {
  ...
  var width = 800.0;
  var topRight = Graphics_Canvas_Geometry.point("")(width)(0.0);
  ...
  var reframe = function (st) {
      return Graphics_Drawing.translate(st.transVector.x)(st.transVector.y)(st.drawing);
  };
  var origin = Graphics_Canvas_Geometry.point("")(0.0)(0.0);
  var moveWithButton = Data_Functor.map(Effect.functorEffect)(function (mouse) {
      return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
          return {
              value: (function () {
                  var $27 = Data_Set.isEmpty(v.buttons);
                  if ($27) {
                      return "buttonup";
                  };
                  return "buttondown";
  ...
  var mag = function (v) {
      return {
          name: v.name,
          coordinates: Data_Semiring.mul(Data_Sparse_Polynomial.semiringPoly(Data_Eq.eqNumber)(Data_Semiring.semiringNumber))(Data_Sparse_Polynomial.monoPol(magFactor)(0))(v.coordinates)
      };
  };
  var height = 600.0;
  var end = Graphics_Canvas_Geometry.point("")(width)(height);
  var drawableFinal = new Graphics_Canvas_Geometry.DrawableSet(function (ctx) {
      return function (v) {
          if (v instanceof FP) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawablePoint)(ctx)(mag(v.value0));
          };
          if (v instanceof FL) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableLine)(ctx)({
                  a: v.value0.a,
                  b: v.value0.b,
                  c: magFactor * v.value0.c
              });
          };
          if (v instanceof FC) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableCircle)(ctx)({
                  center: mag(v.value0.center),
                  radius: magFactor * v.value0.radius
              });
          };
          if (v instanceof FH) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableHalfLine)(ctx)({
                  origin: mag(v.value0.origin),
          ...
          if (v instanceof FS) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSegment)(ctx)({
                  origin: mag(v.value0.origin),
                  extremity: mag(v.value0.extremity),
                  asOriented: v.value0.asOriented
              });
          };
          if (v instanceof FA) {
              return Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSequence(drawableFinal))(ctx)(v.value0);
          };
          throw new Error("Failed pattern match at Main (line 73, column 1 - line 82, column 39): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
  var boxLocalMin = Graphics_Canvas_Geometry.point("")(-6.0)(-5.0);
  var boxLocalMax = Graphics_Canvas_Geometry.point("")(6.0)(5.0);
  var initialState = function (draw) {
      return {
          drawing: (function () {
              var d = Graphics_Canvas_Geometry.point("")(4.0)(-4.0);
              var c = Graphics_Canvas_Geometry.point("")(4.0)(4.0);
              var b = Graphics_Canvas_Geometry.point("")(-4.0)(4.0);
              var a = Graphics_Canvas_Geometry.point("")(-4.0)(-4.0);
              return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(draw(FA.create(Data_Functor.map(Data_Functor.functorArray)(FS.create)([ Graphics_Canvas_Geometry.segment(a)(b)(Data_Maybe.Nothing.value), Graphics_Canvas_Geometry.segment(b)(c)(Data_Maybe.Nothing.value), Graphics_Canvas_Geometry.segment(c)(d)(Data_Maybe.Nothing.value), Graphics_Canvas_Geometry.segment(d)(a)(Data_Maybe.Nothing.value) ]))))(draw(FC.create(Graphics_Canvas_Geometry.circle(Graphics_Canvas_Geometry.point("")(0.0)(0.0))(4.0))));
          })(),
          box: {
              pointMin: boxLocalMin,
              pointMax: boxLocalMax
          },
          transVector: {
              x: -Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(boxLocalMin),
              y: -Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(boxLocalMin)
          },
          scaleFactor: {
              x: width / (Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(boxLocalMax) - Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(boxLocalMin)),
              y: height / (Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(boxLocalMax) - Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(boxLocalMin))
          },
          xtemp: 0.0,
          ytemp: 0.0
      };
  };
  var bottomLeft = Graphics_Canvas_Geometry.point("")(0.0)(height);
  var frame = [ Graphics_Canvas_Geometry.line(origin)(topRight), Graphics_Canvas_Geometry.line(topRight)(end), Graphics_Canvas_Geometry.line(end)(bottomLeft), Graphics_Canvas_Geometry.line(bottomLeft)(origin) ];
  var ePage = function (draw) {
      return Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.liftA1(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(reframe))(function (event) {
          return FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (v) {
              return function (st) {
                  ...
                  if (v.value === "buttondown") {
                      var dy = ((Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMin) - Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMax)) * (v.pos.y - st.ytemp)) / height;
                      var dx = ((Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMin) - Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMax)) * (v.pos.x - st.xtemp)) / width;
                      return {
                          transVector: {
                              x: -magFactor * dx,
                              y: -magFactor * dy
                          ...
                          box: {
                              pointMin: Graphics_Canvas_Geometry.point("")(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMin) + dx)(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMin) + dy),
                              pointMax: Graphics_Canvas_Geometry.point("")(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMax) + dx)(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(st.box.pointMax) + dy)
                          },
                          xtemp: v.pos.x,
                          ytemp: v.pos.y,
                          drawing: st.drawing,
                  ...
                  return {
                      drawing: draw(FA.create(Data_Functor.map(Data_Functor.functorArray)(FL.create)(frame))),
                      box: st.box,
                      transVector: st.transVector,
                      xtemp: st.xtemp,
                      ytemp: st.ytemp,
                      scaleFactor: st.scaleFactor
                  };
              };
          })(event)(initialState(draw));
      }))(moveWithButton);
  };
  var main = function __do() {
      ...
      var v5 = ePage((function (dictDrawableSet) {
          return Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
      })(drawableFinal))();
      var background = Graphics_Drawing.filled(Graphics_Drawing.fillColor(Color.rgb(255)(255)(255)))(Graphics_Drawing.rectangle(0.0)(0.0)(width)(height));
      var v6 = FRP_Behavior.animate(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(background))(v5))(Graphics_Drawing.render(v2))();
      return Data_Unit.unit;
  };
  exports["width"] = width;
  ...
  exports["end"] = end;
  exports["boxLocalMin"] = boxLocalMin;
  exports["boxLocalMax"] = boxLocalMax;
  exports["frame"] = frame;
