...
(function($PS) {
  ...
  var moveWithButton = Data_Functor.map(Effect.functorEffect)(function (mouse) {
      return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
          return {
              value: (function () {
                  var $60 = Data_Set.isEmpty(v.buttons);
                  if ($60) {
                      return "buttonup";
                  };
                  return "buttondown";
  ...
  var visibleInBox = function (v) {
      return function (v1) {
          var candidates = Data_Array.filter(function ($134) {
              return (function (v2) {
                  return v2 === 1;
              })(Data_Array.length($134));
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 170, column 21 - line 170, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 173, column 20 - line 173, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $84 = Data_Array.length(candidates) === 2;
              if ($84) {
                  ...
                  throw new Error("Failed pattern match at Main (line 177, column 28 - line 177, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 167, column 7 - line 178, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  var drawableFinal = new Graphics_Canvas_Geometry.DrawableSet(function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 88, column 1 - line 106, column 39): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
  var initialState = function (draw) {
      return {
          drawing: function (from) {
              return function (to) {
                  return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing))(Data_Monoid.mempty(Graphics_Drawing.monoidDrawing))(Data_Functor.map(Data_Functor.functorArray)(function (n) {
                      return Graphics_Canvas_Geometry.drawIn(drawableFinal)({
                          ...
                          lineWidth: 0.5
                      })(FS.create(from)(to)(Graphics_Canvas_Geometry.segment(Graphics_Canvas_Geometry.point("")(Data_Int.toNumber(n))(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(from.center) - from.halfHeight))(Graphics_Canvas_Geometry.point("")(Data_Int.toNumber(n))(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(from.center) + from.halfHeight))(Data_Maybe.Nothing.value)));
                  })(Data_Array.range(Data_Int.ceil(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(from.center) - from.halfWidth))(Data_Int.floor(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(from.center) + from.halfWidth)))))(Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing))(Data_Monoid.mempty(Graphics_Drawing.monoidDrawing))(Data_Functor.map(Data_Functor.functorArray)(function (n) {
                      return Graphics_Canvas_Geometry.drawIn(drawableFinal)({
                          color: Color.rgb(50)(50)(50),
                          lineWidth: 0.5
                      })(FS.create(from)(to)(Graphics_Canvas_Geometry.segment(Graphics_Canvas_Geometry.point("")(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(from.center) - from.halfWidth)(Data_Int.toNumber(n)))(Graphics_Canvas_Geometry.point("")(Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(from.center) + from.halfWidth)(Data_Int.toNumber(n)))(Data_Maybe.Nothing.value)));
                  })(Data_Array.range(Data_Int.ceil(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(from.center) - from.halfHeight))(Data_Int.floor(Graphics_Canvas_Geometry.ord(Graphics_Canvas_Geometry.basedPoint)(from.center) + from.halfHeight)))));
              };
          },
          from: local,
          to: functionDisplay,
