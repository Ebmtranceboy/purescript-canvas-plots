...
(function($PS) {
  ...
  var reframe = function (v) {
      return v.functionPlot(v.from)(v.to);
  };
                              ...
                              if (v2 instanceof Data_Maybe.Just) {
                                  if (v2.value0.head instanceof Data_Maybe.Just) {
                                      ...
                                      $tco_var_acc = (function () {
                                          var $80 = okY(v.value0.y) && okY(v2.value0.head.value0.y);
                                          if ($80) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 46, column 11 - line 57, column 89): " + [ v2.value0.head.constructor.name ]);
                              };
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  $tco_done = true;
                                  return acc;
                              };
                              throw new Error("Failed pattern match at Main (line 44, column 6 - line 58, column 21): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 38, column 1 - line 38, column 136): " + [ from.constructor.name, acc.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                      while (!$tco_done) {
          ...
          return function (to) {
              return function (v) {
                  ...
                  var zs = Data_Array.dropWhile(function (v1) {
                      ...
                      return botX + (Data_Int.toNumber(n) * (topX - botX)) / 100.0;
                  }))(Data_Array.range(0)(100)));
                  var $94 = Data_Array.length(zs) === 0;
                  if ($94) {
  ...
  var moveWithButton = Data_Functor.map(Effect.functorEffect)(function (mouse) {
      return Data_Functor.map(FRP_Event.functorEvent)(function (v) {
          return {
              value: (function () {
                  var $98 = Data_Set.isEmpty(v.buttons);
                  if ($98) {
                      return "buttonup";
                  };
                  return "buttondown";
  ...
  var functionDisplay = {
      center: Graphics_Canvas_Geometry.point("")(width / 2.0)(height / 6.0),
      halfWidth: width / 2.0,
      halfHeight: height / 6.0
  };
  ...
  var visibleInBox = function (v) {
      return function (v1) {
          var candidates = Data_Array.filter(function ($172) {
              return (function (v2) {
                  return v2 === 1;
              })(Data_Array.length($172));
          ...
          if (inBox(v)(v1.origin)) {
              ...
              throw new Error("Failed pattern match at Main (line 221, column 21 - line 221, column 39): " + [ candidates.constructor.name ]);
          };
          if (inBox(v)(v1.extremity)) {
              ...
              throw new Error("Failed pattern match at Main (line 224, column 20 - line 224, column 38): " + [ candidates.constructor.name ]);
          };
          if (Data_Boolean.otherwise) {
              var $122 = Data_Array.length(candidates) === 2;
              if ($122) {
                  ...
                  throw new Error("Failed pattern match at Main (line 228, column 28 - line 228, column 50): " + [ candidates.constructor.name ]);
              };
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Main (line 218, column 7 - line 229, column 31): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  var drawableFinal = new Graphics_Canvas_Geometry.DrawableSet(function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 133, column 1 - line 151, column 39): " + [ ctx.constructor.name, v.constructor.name ]);
      };
  });
  var grid = function (from) {
      return function (to) {
          ...
          var segAtX = function (x) {
              return FS.create(from)(to)(Graphics_Canvas_Geometry.segment(Graphics_Canvas_Geometry.point("")(x)(botY))(Graphics_Canvas_Geometry.point("")(x)(topY))(Data_Maybe.Nothing.value));
          };
          var botX = Graphics_Canvas_Geometry.abs(Graphics_Canvas_Geometry.basedPoint)(from.center) - from.halfWidth;
          var segAtY = function (y) {
              return FS.create(from)(to)(Graphics_Canvas_Geometry.segment(Graphics_Canvas_Geometry.point("")(botX)(y))(Graphics_Canvas_Geometry.point("")(topX)(y))(Data_Maybe.Nothing.value));
          };
          return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing))(Data_Monoid.mempty(Graphics_Drawing.monoidDrawing))(Data_Functor.map(Data_Functor.functorArray)(function (n) {
              return Graphics_Canvas_Geometry.drawIn(drawableFinal)({
                  color: Color.rgb(50)(50)(50),
                  lineWidth: 0.5
              })(segAtX(Data_Int.toNumber(n)));
              ...
              return Graphics_Canvas_Geometry.drawIn(drawableFinal)({
                  color: Color.rgb(50)(50)(50),
                  lineWidth: 0.5
              })(segAtY(Data_Int.toNumber(n)));
          })(Data_Array.range(Data_Int.ceil(botY))(Data_Int.floor(topY)))))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Graphics_Canvas_Geometry.drawIn(drawableFinal)({
              color: Color.rgb(50)(50)(50),
              lineWidth: 1.5
          })(segAtX(0.0)))(Graphics_Canvas_Geometry.drawIn(drawableFinal)({
              color: Color.rgb(50)(50)(50),
              lineWidth: 1.5
          })(segAtY(0.0)))));
      };
  ...
  var initialState = function (draw) {
      return {
          functionPlot: function (from) {
              return function (to) {
                  return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(grid(from)(to))(plot(draw)(from)(to)(inverse));
              };
          },
          from: local,
          to: functionDisplay,
  ...
  var ePage = function (ev) {
      return function (draw) {
          return Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.liftA1(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(reframe))(function (event) {
              return FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (v) {
                  return function (st) {
                      if (v.value === "Clicked") {
                          return {
                              from: {
                                  halfWidth: st.from.halfWidth * 1.1,
                                  center: st.from.center,
                                  halfHeight: st.from.halfHeight
                              },
                              previousX: st.previousX,
                              previousY: st.previousY,
                              to: st.to,
                              functionPlot: st.functionPlot
                          };
                      };
                      if (v.value === "buttonup") {
                          return {
                      ...
                      if (v.value === "buttondown") {
                          var q = remap(st.to)(Graphics_Canvas_Geometry.point("")(v.pos.x)(v.pos.y))(st.from);
                          var p = remap(st.to)(Graphics_Canvas_Geometry.point("")(st.previousX)(st.previousY))(st.from);
                          return {
                              from: {
                                  center: Graphics_Canvas_Geometry.plus(Graphics_Canvas_Geometry.summublePointVector)(st.from.center)(Graphics_Canvas_Geometry.vector(q)(p)),
                                  halfHeight: st.from.halfHeight,
                                  halfWidth: st.from.halfWidth
                              },
                              previousX: v.pos.x,
                              previousY: v.pos.y,
                              to: st.to,
              ...
              })(Control_Alt.alt(FRP_Event.altEvent)(event)(ev.event))(initialState(draw));
          }))(moveWithButton);
      };
  };
  var cb = function (v) {
  ...
  var main = function __do() {
      ...
      var displayHeight = 2.0 * functionDisplay.halfHeight;
      var background = Graphics_Drawing.filled(white)(Graphics_Drawing.rectangle(0.0)(0.0)(width)(height));
      var outDisplay = Graphics_Drawing.filled(white)(Graphics_Drawing.rectangle(0.0)(displayHeight)(width)(height - displayHeight));
      var v5 = DOM_Editor.createElement("button")(v.document)();
      var v6 = DOM_Editor.setTextContent("Click")(v5)();
      var v7 = DOM_Editor.appendChild(v5)(v.body)();
      var v8 = FRP_Event.create();
      var v9 = DOM_Editor.addEventListener(cb(v8))(DOM_Editor.click)(v5)();
      var v10 = ePage(v8)((function (dictDrawableSet) {
          return Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
      })(drawableFinal))();
      var v11 = FRP_Behavior.animate(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(background))(Data_Semigroup.append(FRP_Behavior.semigroupABehavior(FRP_Event.functorEvent)(Graphics_Drawing.semigroupDrawing))(v10)(Control_Applicative.pure(FRP_Behavior.applicativeABehavior(FRP_Event.functorEvent))(Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSequence(Graphics_Canvas_Geometry.drawableSegment))(ctx)(frame(functionDisplay))))))(Graphics_Drawing.render(v2))();
      return Data_Unit.unit;
  };
  exports["width"] = width;
  ...
  exports["inBox"] = inBox;
  exports["visibleInBox"] = visibleInBox;
  exports["cb"] = cb;
  exports["main"] = main;
